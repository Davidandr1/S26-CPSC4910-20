...
ADD FOREIGN KEY (Actor_User_ID) REFERENCES USERS(User_ID);
FOREIGN KEY (User_ID) REFERENCES USERS(User_ID)
);
...
Driver_Points INT NOT NULL DEFAULT 0,
PRIMARY KEY (Driver_ID, Sponsor_ID),
FOREIGN KEY (Driver_ID) REFERENCES DRIVERS(User_ID),
FOREIGN KEY (Sponsor_ID) REFERENCES SPONSORS(Sponsor_ID)
);

CREATE TABLE DRIVER_SPONSOR_APPLICATIONS(
Driver_Sponsor_App_ID INT AUTO_INCREMENT PRIMARY KEY,
Driver_ID INT NOT NULL,
Sponsor_ID INT NOT NULL,
Application_Status ENUM("Pending", "Approved", "Denied") DEFAULT "Pending",
